This chart shows the secondary attack rate (sar%) fpr category 3 notifications, calculated as
...
secondary attack rate = secondary attacks / number of notifications category 3 
