Shows a percentage of the number of ENX users that are using ENPA. This estimate tends to be rather noisy, and we would expect that the actual count wouldn't change very quickly. 
